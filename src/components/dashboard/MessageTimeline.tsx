    ...
    return (
      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
        <div className="px-4 py-3 border-b border-gray-200 flex items-center gap-2">
          <span>📈</span>
          <h2 className="font-semibold text-gray-700">Timeline</h2>
        </div>
        <div className="text-center text-gray-400 text-sm py-8">No timeline data</div>
      </div>
    )
  }
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200">
      ...
      <div className="p-4">
        ...
        >
          <line x1={0} y1={BASELINE_Y} x2={VIEW_WIDTH} y2={BASELINE_Y} stroke="#E5E7EB" strokeWidth={1} />
          ...
          {notifications.map((n, i) => {
            ...
            return (
              ...
              >
                <line x1={cx} y1={26} x2={cx} y2={BASELINE_Y} stroke="#ef4444" strokeWidth={1} strokeDasharray="4 3" opacity={0.5} />
                <circle cx={cx} cy={16} r={6} fill="#ef4444">
        ...
        <div className="flex items-center gap-4 text-xs text-gray-500 mt-3">
          <span className="flex items-center gap-1.5">
            <span className="w-3 h-3 rounded-sm bg-blue-500 inline-block" /> UPDATE
          </span>
          <span className="flex items-center gap-1.5">
            <span className="w-3 h-3 rounded-full bg-red-500 inline-block" /> NOTIFICATION
          </span>
        </div>
      </div>
    </div>
